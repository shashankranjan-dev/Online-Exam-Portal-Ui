...
function Hero() {
  return (
    <>
      <hr />
      <div class="mx-auto max-w-screen-xl px-4 mt-4  md:px-8">
          ...
          <div class="flex flex-col justify-between xl:w-5/12">
            ...
            <div class="sm:text-center lg:py-12 lg:text-left xl:py-24">
              ...
              <div class="grid grid-cols-1">
                <div class="w-full border-gray-400 border max-w-lg mx-auto my-4 bg-white shadow-xl rounded-xl">
                  <div class="p-6">
                    <div>
                      <div class="mt-3 text-left sm:mt-2">
              ...
              <div class="flex flex-col gap-2.5 mt-2 sm:flex-row sm:justify-center lg:justify-start">
                <a
                  href="!#"
